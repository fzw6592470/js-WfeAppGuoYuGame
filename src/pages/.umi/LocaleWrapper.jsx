...
const localeInfo = {
  'en-US': {
    messages: require('/opt/app/appservice/js-WfeAppGuoYuGame/src/locales/en-US.js').default,
    locale: 'en-US',
    antd: require('antd/lib/locale-provider/en_US'),
    data: require('react-intl/locale-data/en'),
  },
  'zh-CN': {
    messages: require('/opt/app/appservice/js-WfeAppGuoYuGame/src/locales/zh-CN.js').default,
    locale: 'zh-CN',
